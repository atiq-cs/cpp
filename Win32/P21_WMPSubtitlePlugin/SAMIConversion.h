...
//
// Author  :  Atiq
// Remarks :  This header provides declarations for subtitle to SAMI conversion
/////////////////////////////////////////////////////////////////////////////
...
public:
  SubToSAMIConverter(LPTSTR infileName, BOOL bLogStatus, BOOL bSAMIInTemp);
  ~SubToSAMIConverter();
  BOOL convert_to_sami();
  void writeLog(LPTSTR str);    // need as public for external access
  LPTSTR GetSMIFileName() { return outSmiFileName; }
